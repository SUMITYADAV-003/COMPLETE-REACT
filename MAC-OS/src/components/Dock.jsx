...
const Dock = () => {
  return (
    <footer className='dock'>
      ...
      <div className='icon sticky'><img src="/doc-icons/sticky.svg" alt="sticky" /></div>
      <div className='icon terminal'><img src="/doc-icons/terminal.svg" alt="terminal" /></div>
      <div className='icon mail'><img src="/doc-icons/mail.svg" alt="mail" /></div>
      <div className='icon links'><img src="/doc-icons/links.svg" alt="links" /></div>
